...
class Scope(models.Model):
    tag = models.ForeignKey(Tag, on_delete=models.CASCADE, related_name='tags_scopes')
    article = models.ForeignKey(Article, on_delete=models.CASCADE, related_name='art_scopes')
